...
_import_structure = {
    ...
    "models.audiomistral": ["AudioMistralConfig"],
...
try:
    ...
    _import_structure["models.llava_next_video"].append(
...
try:
    ...
    _import_structure["image_processing_utils_fast"] = [
...
try:
    ...
    _import_structure["models.audiomistral"].extend(
        [
...
try:
    ...
    _import_structure["models.mistral"].extend(
        ["TFMistralForCausalLM", "TFMistralForSequenceClassification",
            "TFMistralModel", "TFMistralPreTrainedModel"]
    )
    _import_structure["models.mobilebert"].extend(
        [
...
try:
    ...
    _import_structure["models.musicgen_melody"].append(
...
if TYPE_CHECKING:
    ...
    from .models.audiomistral import AudioMistralConfig
    ...
    try:
        ...
        from .models.audiomistral import (
            AudioMistralForCausalLM,
            AudioMistralModel,
            AudioMistralPreTrainedModel,
        )
