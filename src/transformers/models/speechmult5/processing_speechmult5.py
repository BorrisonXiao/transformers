...
"""Speech processor class for SpeechMult5."""

from ...processing_utils import ProcessorMixin


class SpeechMult5Processor(ProcessorMixin):
    r"""
    Constructs a SpeechMult5 processor which wraps a feature extractor and a tokenizer into a single processor.

    [`SpeechMult5Processor`] offers all the functionalities of [`SpeechMult5FeatureExtractor`] and [`SpeechMult5Tokenizer`]. See
    the docstring of [`~SpeechMult5Processor.__call__`] and [`~SpeechMult5Processor.decode`] for more information.

    Args:
        feature_extractor (`SpeechMult5FeatureExtractor`):
            An instance of [`SpeechMult5FeatureExtractor`]. The feature extractor is a required input.
        tokenizer (`SpeechMult5Tokenizer`):
            An instance of [`SpeechMult5Tokenizer`]. The tokenizer is a required input.
    """

    feature_extractor_class = "SpeechMult5FeatureExtractor"
    tokenizer_class = "SpeechMult5Tokenizer"
    ...
    def __call__(self, *args, **kwargs):
        ...
        `audio_target`. This forwards the arguments to SpeechMult5FeatureExtractor's
        [`~SpeechMult5FeatureExtractor.__call__`].

        You can process text by using the argument `text`, or process text labels by using the argument `text_target`.
        This forwards the arguments to SpeechMult5Tokenizer's [`~SpeechMult5Tokenizer.__call__`].
    ...
    def pad(self, *args, **kwargs):
        ...
        Audio inputs are padded by SpeechMult5FeatureExtractor's [`~SpeechMult5FeatureExtractor.pad`]. Text inputs are padded
        by SpeechMult5Tokenizer's [`~SpeechMult5Tokenizer.pad`].
    ...
    def batch_decode(self, *args, **kwargs):
        """
        This method forwards all its arguments to SpeechMult5Tokenizer's [`~SpeechMult5Tokenizer.batch_decode`]. Please refer
    ...
    def decode(self, *args, **kwargs):
        """
        This method forwards all its arguments to SpeechMult5Tokenizer's [`~SpeechMult5Tokenizer.decode`]. Please refer to
