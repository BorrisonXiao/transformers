...
"""Feature extractor class for SpeechMult5."""
...
class SpeechMult5FeatureExtractor(SequenceFeatureExtractor):
    r"""
    Constructs a SpeechMult5 feature extractor.

    This class can pre-process a raw speech signal by (optionally) normalizing to zero-mean unit-variance, for use by
    the SpeechMult5 speech encoder prenet.

    This class can also extract log-mel filter bank features from raw speech, for use by the SpeechMult5 speech decoder
    prenet.
    ...
    Args:
        ...
        return_attention_mask (`bool`, *optional*, defaults to `True`):
            Whether or not [`~SpeechMult5FeatureExtractor.__call__`] should return `attention_mask`.
    """
