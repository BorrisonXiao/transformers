...
"""Convert SpeechMult5 HiFi-GAN checkpoint."""
...
from transformers import SpeechMult5HifiGan, SpeechMult5HifiGanConfig, logging
...
def convert_hifigan_checkpoint(
    ...
    if config_path is not None:
        config = SpeechMult5HifiGanConfig.from_pretrained(config_path)
    else:
        config = SpeechMult5HifiGanConfig()

    model = SpeechMult5HifiGan(config)
